...
public class FileController {
	...
	public String addok(Model model, String txt, MultipartFile attach, HttpServletRequest req) {
		...
		System.out.println(attach.getContentType()); //application/x-zip-compressed (파일의 MIME 타입 출력 > image/png)
		System.out.println(attach.getSize()); //1650816 (파일의 크기 (바이트 단위))
		System.out.println(attach.isEmpty()); //false (파일의 비어있는지 여부)
		...
		try {
			...
			//	- 공인된 난수 > 네트워크 상에서 고유성이 보장되는 ID를 만들기 위한 표준
			//	- 시간 + 난수 조합
